...
int main(void)
{
    ...
    std::cout << std::endl << "\033[1;33m- Creating new shrubbery creation form\033[0m" << std::endl;
	Form *form1 = new ShrubberyCreationForm("pot");
    ...
    std::cout << std::endl << "\033[1;33m- Creating new robotomy request form\033[0m" << std::endl;
	Form *form2 = new RobotomyRequestForm("Dummy");
    ...
    std::cout << std::endl << "\033[1;33m- Creating new presidential pardon form\033[0m" << std::endl;
	Form *form3 = new PresidentialPardonForm("Pol");
    ...
    std::cout << std::endl << "\033[1;33m- Creating new shrubbery creation form\033[0m" << std::endl;
	Form *form4 = new ShrubberyCreationForm("garden");
