...
/*   Updated: 2021/03/01 14:45:01 by mmonroy-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
_EP(this->getMaxEP())
{
	std::cout << "Starting bootup squence for the '" << this->getName()
...
void			FragTrap::vaulthunter_dot_exe(std::string const &target)
{
	...
	std::cout << "FR4G-TP " << this->getName() << " " << randomAttack[randomNumber]
	<< ". The " << target << " receives " << this->getMeleeDMG() << " points of damage!"
	<< std::endl;
	return;
}
